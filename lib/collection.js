...
function () {
  ...
  _createClass(ServiceCollection, [{
    ...
    value: function _push(service, desc) {
      ...
      desc.value = service;
      desc.klass = (0, _util.isClass)(service);
    ...
    value: function transient(service, name, deps) {
      if (!(0, _util.isFunction)(service)) throw new Error('Transient service must be a function or class');
    ...
    value: function scoped(service, name, deps) {
      if (!(0, _util.isFunction)(service)) throw new Error('Scoped service must be a function or class');
