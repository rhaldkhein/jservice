  ...
  _createClass(Container, [{
    ...
    value: function start() {
      ...
      return Promise.all(this.collection.asyncs).then(function () {
        return Promise.all(_this.invoke('start'));
      }).then(function () {
        return Promise.all(_this.invoke('prepare'));
      }).then(function () {
        _this.isReady = true;
    ...
    value: function invoke(event) {
      ...
      services.forEach(function (service) {
        ...
        if (method) results.push(method(_this2.provider, _this2.provider._pickDesc(service)));
      });
      return results;
    }
  }, {
