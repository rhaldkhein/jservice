...
function () {
  ...
  _createClass(ServiceProvider, [{
    ...
    key: "_createService",
    value: function _createService(index, name) {
      ...
      var instance,
          Service = typeof index === 'number' ? this._collection.services[index] : index; // Validate resolution, singleton must not resolve scoped or transient.
    ...
    value: function _instantiate(Service) {
      ...
      return (0, _util.isConstructor)(Service) ? new Service(this, (0, _util.isFunction)(config) ? config(this) : config) : Service();
    }
  }]);
