...
function () {
  ...
  _createClass(ServiceProvider, [{
    ...
    key: "getRequired",
    value: function getRequired(name) {
      return this.getRequiredService(name);
    }
  }, {
    key: "getRequiredService",
    value: function getRequiredService(name) {
      var index = this._collection.names[name.toLowerCase()];

      if (index === undefined) throw new Error("Missing required service \"".concat(name, "\""));
      return this.createService(index);
    }
  }, {
    key: "createService",
