...
function () {
  ...
  _createClass(ServiceProvider, [{
    ...
    value: function _createService(index, name) {
      ...
      var instance,
          Service = typeof index === 'number' ? this._collection.services[index] : Service; // Validate resolution, singleton must not resolve scoped or transient.
    ...
    value: function _instantiate(Service) {
      ...
      return (0, _util.isFunction)(Service) ? Service() : Service;
    }
  }]);
